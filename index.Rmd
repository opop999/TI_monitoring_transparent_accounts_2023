...
output: 
  flexdashboard::flex_dashboard:
    logo: "input/dashboard/logo_ti.svg"
...
params:
  ...
  end_date: "2023-01-27"
  packages: ["dplyr", "ggplot2", "forcats", "tidyr", "reactable", "reactablefmtr", "stringr", "plotly", "flexdashboard", "htmlwidgets"]
  input_dir: "output/summary_tables"
...
total_spending <- readRDS(file = file.path(params$input_dir, "total_spending.rds"))
time_spending <- readRDS(file = file.path(params$input_dir, "time_spending.rds"))
total_income <- readRDS(file = file.path(params$input_dir, "total_income.rds"))
time_income <- readRDS(file = file.path(params$input_dir, "time_income.rds"))
